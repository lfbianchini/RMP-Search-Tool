...
public class App {
        ...
        public static String getUniversityID(String name) throws IOException {
            ...
            //#root > div > div > div:nth-child(3) > div.SearchResultsPage__StyledSearchResultsPage-vhbycj-0.bgplVn > div.SearchResultsPage__SearchResultsWrapper-vhbycj-1.gxbBpy > div:nth-child(3) > a:nth-child(1)
        ...
        public static String getProfessorId(String universityID, String name) throws IOException { 
            ...
            //a.TeacherCard__StyledTeacherCard-syjs0d-0:nth-child(1)
            //#root > div > div > div:nth-child(3) > div.SearchResultsPage__StyledSearchResultsPage-vhbycj-0.bgplVn > div.SearchResultsPage__SearchResultsWrapper-vhbycj-1.gxbBpy > div:nth-child(5) > a:nth-child(1)
        ...
        public static String getProfessorRating(String professorID) throws IOException {
            ...
            String rating = pageElements.first().text();
            return rating;
        }
